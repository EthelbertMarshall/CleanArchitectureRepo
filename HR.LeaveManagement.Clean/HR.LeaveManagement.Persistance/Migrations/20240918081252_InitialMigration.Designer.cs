...
namespace HR.LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20240918081252_InitialMigration")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 9, 18, 13, 42, 51, 567, DateTimeKind.Local).AddTicks(4377),
                            DateModified = new DateTime(2024, 9, 18, 13, 42, 51, 567, DateTimeKind.Local).AddTicks(4403),
                            DefaultDays = 1,
                            Name = "Day Off"
                        });
                });
